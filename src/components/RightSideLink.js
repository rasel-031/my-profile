...
const LeftSideLink = () => {
  return (
    <div className="h-[100vh] w-[10vw] flex items-end justify-center fixed z-50 bottom-0 right-0">
      <div className="text-customSlate flex flex-col items-center justify-center gap-32">
        <a
          href="mailto:raselbishwas997@gmail.com"
          target="_blank"
          rel="noreferrer"
          className="cursor-pointer hover:text-customGreen transform rotate-90 transform-origin-top-right w-[10vw]"
        >
